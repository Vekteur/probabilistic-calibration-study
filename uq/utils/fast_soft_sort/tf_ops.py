...
def soft_rank(
    ...
    func = _wrap_numpy_op(numpy_ops.SoftRank, regularization_strength, direction, regularization)
...
def soft_sort(
    ...
    func = _wrap_numpy_op(numpy_ops.SoftSort, regularization_strength, direction, regularization)
